...
function VoronoiGraph(){
	...
	this.displayVoronoi = function(event){
	   ...
	   //graph = new VDGraph({interactionType: "pointGraph"},voronoiGraph.container.graphDiv);
...
        
		...
		for(i=0; i<tri.length; i++){
			...
			var center = graph.createPoint(getCircle(p1,p2,p3),{visible:true,fillColor: "blue", strokeColor: "blue" });
